...
public final class Equipment extends Category {
    ...
    public void initialize(final SortingMode sortingMode) {
        ...
        addMaterialIfExists(MISC, "BLACK_HARNESS");
        addMaterialIfExists(MISC, "BLUE_HARNESS");
        addMaterialIfExists(MISC, "BROWN_HARNESS");
        addMaterialIfExists(MISC, "CYAN_HARNESS");
        addMaterialIfExists(MISC, "GRAY_HARNESS");
        addMaterialIfExists(MISC, "GREEN_HARNESS");
        addMaterialIfExists(MISC, "LIGHT_BLUE_HARNESS");
        addMaterialIfExists(MISC, "LIGHT_GRAY_HARNESS");
        addMaterialIfExists(MISC, "LIME_HARNESS");
        addMaterialIfExists(MISC, "MAGENTA_HARNESS");
        addMaterialIfExists(MISC, "ORANGE_HARNESS");
        addMaterialIfExists(MISC, "PINK_HARNESS");
        addMaterialIfExists(MISC, "PURPLE_HARNESS");
        addMaterialIfExists(MISC, "RED_HARNESS");
        addMaterialIfExists(MISC, "WHITE_HARNESS");
        addMaterialIfExists(MISC, "YELLOW_HARNESS");
